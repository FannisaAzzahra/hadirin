...
<style>
    ...
    .card-header {
        background: linear-gradient(135deg, #00b4d8 0%, #0077b6 100%); /* Gradien biru Hadirin, default untuk card-header */
        color: white;
    ...
    /* Info Card Specific (Perhatian) */
    .card.border-info { /* Changed from border-warning to border-info */
        border: 1px solid #0dcaf0 !important; /* Blue border */
    }

    .card-header.bg-info.bg-opacity-10 { /* Changed from bg-warning to bg-info */
        background-color: rgba(13, 202, 240, 0.1) !important; /* Light blue background */
    }

    /* Ensure text-warning is only for actual warnings, not the header title now */
    .text-warning {
...
<div class="container-fluid py-4">
    <div class="row justify-content-center">
        <div class="col-lg-8">
                    ...
                    <form action="{{ route('company-units.update', $companyUnit) }}" method="POST">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                {{-- Pilih Perusahaan --}}
                                <div class="mb-3">
                                    <label for="company_id" class="form-label"> {{-- Removed fw-semibold --}}
                            ...
                            <div class="col-md-6">
                                {{-- Sort Order --}}
                                <div class="mb-3">
                                    <label for="sort_order" class="form-label"> {{-- Removed fw-semibold --}}
                                        Urutan Tampilan
                                    </label>
                                    <input type="number"
                        ...
                        {{-- Nama Unit --}}
                        <div class="mb-3">
                            <label for="name" class="form-label"> {{-- Removed fw-semibold --}}
                        ...
                        {{-- Deskripsi --}}
                        <div class="mb-3">
                            <label for="description" class="form-label"> {{-- Removed fw-semibold --}}
                                Deskripsi
                            </label>
                        ...
                        <div class="mb-4">
                            <div class="form-check form-switch">
                                ...
                                <label class="form-check-label" for="is_active"> {{-- Removed fw-semibold --}}
                                    Status Aktif
                                </label>
                            </div>
                            <div class="form-text">
            ...
            {{-- Info Card --}}
            <div class="card mt-4 border-info"> {{-- Changed border-warning to border-info --}}
                <div class="card-header bg-info bg-opacity-10 border-info"> {{-- Changed bg-warning bg-opacity-10 to bg-info bg-opacity-10 --}}
                    <h6 class="card-title mb-0 text-white"> {{-- Changed text-warning to text-white --}}
