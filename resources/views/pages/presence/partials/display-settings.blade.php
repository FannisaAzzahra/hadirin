                                ...
                                <div class="preview-logos">
                                    @if($presence->logo_kiri)
                                        <div class="preview-logo-item">
                                            <img src="{{ route('public.storage-image', $presence->logo_kiri) }}" class="preview-logo-image" alt="Logo Kiri">
                                            <div class="preview-logo-label">Logo Kiri</div>
                                        </div>
                                    @endif
                                    @if($presence->logo_kanan)
                                        <div class="preview-logo-item">
                                            <img src="{{ route('public.storage-image', $presence->logo_kanan) }}" class="preview-logo-image" alt="Logo Kanan">
                                            <div class="preview-logo-label">Logo Kanan</div>
                                        </div>
                                    @endif
                                    @if($presence->logo_ig)
                                        <div class="preview-logo-item">
                                            <img src="{{ route('public.storage-image', $presence->logo_ig) }}" class="preview-logo-image" alt="Logo Instagram">
            ...
            <div class="form-row triple">
                <div class="form-group">
                    ...
                    @if(isset($presence) && $presence->logo_kiri)
                        <div style="margin-top: 0.5rem;">
                            <img src="{{ route('public.storage-image', $presence->logo_kiri) }}" class="hadirin-img-preview">
                ...
                <div class="form-group">
                    ...
                    @if(isset($presence) && $presence->logo_kanan)
                        <div style="margin-top: 0.5rem;">
                            <img src="{{ route('public.storage-image', $presence->logo_kanan) }}" class="hadirin-img-preview">
                            <small>Logo saat ini</small>
                        </div>
                    @endif
                </div>
                ...
                <div class="form-group">
                    ...
                    @if(isset($presence) && $presence->logo_ig)
                        <div style="margin-top: 0.5rem;">
                            <img src="{{ route('public.storage-image', $presence->logo_ig) }}" class="hadirin-img-preview">
                            <small>Logo saat ini</small>
                        </div>
                    @endif
                </div>
                    ...
                    try {
                        ...
                        if (display.logo_kiri || display.logo_kanan || display.logo_ig) {
                            ...
                            if (display.logo_kiri) {
                                previewHTML += `
                                    <div class="preview-logo-item">
                                        <img src="/storage-image/${display.logo_kiri}" class="preview-logo-image" alt="Logo Kiri">
                                        <div class="preview-logo-label">Logo Kiri</div>
                                    </div>
                                `;
                            }
                            ...
                            if (display.logo_kanan) {
                                previewHTML += `
                                    <div class="preview-logo-item">
                                        <img src="/storage-image/${display.logo_kanan}" class="preview-logo-image" alt="Logo Kanan">
                                        <div class="preview-logo-label">Logo Kanan</div>
                                    </div>
                                `;
                            }
                            ...
                            if (display.logo_ig) {
                                previewHTML += `
                                    <div class="preview-logo-item">
                                        <img src="/storage-image/${display.logo_ig}" class="preview-logo-image" alt="Logo Instagram">
                                        <div class="preview-logo-label">Logo Instagram</div>
                                    </div>
                                `;
                            }
