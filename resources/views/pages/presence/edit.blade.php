                ...
                <form action="{{ route('presence.update', $presence->id) }}" method="post">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" name="lokasi" id="lokasi"
                            placeholder="Contoh: Zoom, Ruang Rapat"
                    ...
                    <div class="mb-3">
                        ...
                        <input type="datetime-local" class="form-control" name="batas_waktu" id="batas_waktu" value="{{ old('batas_waktu', $presence->batas_waktu ? date('Y-m-d\TH:i', strtotime($presence->batas_waktu)) : '') }}">
                    </div>
