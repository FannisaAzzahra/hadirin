...
<style>
    ...
    * {
    ...
    /* Header Bagian (misalnya "Informasi Kegiatan" atau "Pengaturan Tampilan") */
    ...
    .form-grid {
        display: grid;
        gap: 2rem; /* Jarak antar grup form */
    ...
    .form-row {
        ...
        gap: 1.8rem; /* Jarak antar kolom dalam satu baris */
    }
    ...
    /* Section spacing */
    .section-divider {
        height: 3rem; /* Menyesuaikan tinggi divider */
    }

    /* Existing image style, adjusted for consistency */
    .hadirin-img-preview { /* Mengubah img-preview menjadi hadirin-img-preview */
        max-height: 90px; /* Menyesuaikan ukuran gambar */
        object-fit: cover;
        border-radius: 8px;
        border: 1px solid #e8eaed; /* Border Hadirin */
        margin-top: 0.8rem; /* Menyesuaikan margin */
        ...
        <div class="hadirin-app-header">
            ...
            <div class="header-content">
                <h1 class="hadirin-header-title">
                    <i class="fas fa-edit"></i> <!-- Ikon disesuaikan untuk edit -->
                    Edit Kegiatan
                </h1>
