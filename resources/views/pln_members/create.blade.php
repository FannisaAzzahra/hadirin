...
.hadirin-app-header {
    ...
    /* border-bottom: 3px solid #ffd60a; */ /* Dihapus agar transisi lebih mulus */
    color: white;
    padding: 2.2rem;
    text-align: center;
    position: relative;
    overflow: hidden;
    /* border-top-left-radius: 20px; */ /* Dihapus karena sudah diatur di .hadirin-app-card */
    /* border-top-right-radius: 20px; */ /* Dihapus karena sudah diatur di .hadirin-app-card */
    display: flex;
