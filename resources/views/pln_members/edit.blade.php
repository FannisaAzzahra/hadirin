...
<style>
    ...
    * {
    ...
    .hadirin-label {
        font-weight: 600;
        color: #1a1a1a;
        margin-bottom: 0.8rem; /* Jarak bawah label */
    ...
    .invalid-feedback { /* Menggunakan nama umum */
        ...
        margin-top: 0.6rem; /* Jarak atas pesan error */
    ...
    @media (max-width: 768px) {
        .app-container {
            margin: 10px; /* Mengurangi margin samping agar lebih responsif */
            padding: 0 10px;
        }
...
<div class="app-container">
    <div class="hadirin-app-card"> {{-- Ini adalah satu kartu utama yang membungkus seluruh konten --}}
        <div class="hadirin-app-header">
            ...
            <a href="{{ route('pln-members.index') }}" class="hadirin-header-btn">
            ...
            <form action="{{ route('pln-members.update', $plnMember->id) }}" method="POST">
                ...
                <div class="hadirin-section-header">
                    <div class="hadirin-section-icon">
                        <i class="fas fa-info-circle"></i> {{-- Ikon untuk Informasi Anggota --}}
                    </div>
                    <h3 class="hadirin-section-title">Informasi Anggota</h3>
                </div>

                <div class="form-grid">
                    <div class="form-row">
                        <div class="form-group">
                            <label for="nama" class="hadirin-label">Nama Lengkap <span style="color: #dc3545;">*</span></label>
                            <input type="text"
                                   class="hadirin-input @error('nama') is-invalid @enderror"
                                   name="nama"
                                   id="nama"
                                   value="{{ old('nama', $plnMember->nama) }}"
                        ...
                        <div class="form-group">
                            <label for="nip" class="hadirin-label">NIP <span style="color: #dc3545;">*</span></label>
                            <input type="text"
                                   class="hadirin-input @error('nip') is-invalid @enderror"
                                   name="nip"
                                   id="nip"
                                   value="{{ old('nip', $plnMember->nip) }}"
                    ...
                    <div class="form-row">
                        <div class="form-group">
                            ...
                            <input type="email"
                                   ...
                                   name="email"
                                   id="email"
                                   value="{{ old('email', $plnMember->email) }}"
                        ...
                        <div class="form-group">
                            <label for="no_hp" class="hadirin-label">No HP <span style="color: #dc3545;">*</span></label>
                            <input type="text"
                                   class="hadirin-input @error('no_hp') is-invalid @enderror"
                                   name="no_hp"
                                   id="no_hp"
                                   value="{{ old('no_hp', $plnMember->no_hp) }}"
                    ...
                    <div class="form-row single">
                        <div class="form-group">
                            <label for="jabatan" class="hadirin-label">Jabatan <span style="color: #dc3545;">*</span></label>
                            <input type="text"
                                   name="jabatan"
                                   id="jabatan"
                                   value="{{ old('jabatan', $plnMember->jabatan) }}"
                                   placeholder="Masukkan jabatan"
                                   class="hadirin-input @error('jabatan') is-invalid @enderror">
                            @error('jabatan')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                ...
                <div class="action-buttons">
                    <a href="{{ route('pln-members.index') }}" class="hadirin-btn hadirin-btn-secondary">
                        <i class="fas fa-times"></i> {{-- Ikon X untuk Batal --}}
                        Batal
                    </a>
                    <button type="submit" class="hadirin-btn hadirin-btn-primary">
                        <i class="fas fa-save"></i> {{-- Ikon simpan untuk Update --}}
                        Update Anggota
                    </button>
                </div>
            </form>
