                ...
                <form action="{{ route('pln-members.update', $plnMember->id) }}" method="POST">
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control @error('nama') is-invalid @enderror" 
                                name="nama" id="nama" value="{{ old('nama', $plnMember->nama) }}"
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control @error('nip') is-invalid @enderror" 
                                name="nip" id="nip" value="{{ old('nip', $plnMember->nip) }}"
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="email" class="form-control @error('email') is-invalid @enderror" 
                                name="email" id="email" value="{{ old('email', $plnMember->email) }}"
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control @error('no_hp') is-invalid @enderror" 
                                name="no_hp" id="no_hp" value="{{ old('no_hp', $plnMember->no_hp) }}"
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control @error('jabatan') is-invalid @enderror" 
                            name="jabatan" id="jabatan" value="{{ old('jabatan', $plnMember->jabatan) }}"
